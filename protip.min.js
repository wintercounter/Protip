...
i.type===e.EVENT_CLICK&&o.data.trigger===e.TRIGGER_CLICK&&i.preventDefault(),o.actionHandler(i.type)},_onResize:function(){!this._task.resize&&this._hideAll(),this._task.resize&&clearTimeout(this._task.resize),this._task.resize=setTimeout(function(){this._showAll(),this._task.resize=void 0,this._visibleBeforeResize=[]}.bind(this),100)},_onBodyClick:function(i){var s=t(i.target),o=s.parents("."+e.SELECTOR_PREFIX+e.SELECTOR_CONTAINER),n=e.SELECTOR_PREFIX+e.SELECTOR_CONTAINER,h=s.hasClass(n)?s:o.size()?o:!1,r=this._isInited(s)?this.getItemInstance(s):!1
r&&r.data.trigger===e.TRIGGER_CLICK||t.each(this._itemInstances,function(t,i){i.isVisible()&&i.data.trigger===e.TRIGGER_CLICK&&(!h||i.el.protip.get(0)!==h.get(0))&&i.hide()})},_onCloseClick:function(i){var s=t(i.currentTarget).parents("."+e.SELECTOR_PREFIX+e.SELECTOR_CONTAINER).data(this.namespaced(e.PROP_IDENTIFIER))
