...
try{window.MutationObserver._period=100}catch(s){window.MutationObserver=window.MutationObserver||function(){this.disconnect=this.observe=function(){}}}var o=function(t){return this._Construct(t)}
return t.extend(!0,o.prototype,{_defaults:{selector:e.DEFAULT_SELECTOR,namespace:e.DEFAULT_NAMESPACE,protipTemplate:e.TEMPLATE_PROTIP,arrowTemplate:e.TEMPLATE_ARROW,iconTemplate:e.TEMPLATE_ICON,observer:!0,skin:e.SKIN_DEFAULT,size:e.SIZE_DEFAULT,scheme:e.SCHEME_DEFAULT,animate:!1,offset:0,forceMinWidth:!0},_Construct:function(e){return this.settings=t.extend({},this._defaults,e),this._itemInstances={},this._observerInstance=void 0,this._visibleBeforeResize=[],this._task={delayIn:void 0,delayOut:void 0,resize:void 0},this._fetchElements(),this._bind(),this},destroy:function(){this._unbind(),t.each(this._itemInstances,t.proxy(function(t){this.destroyItemInstance(t)},this)),this._itemInstances=void 0,this.settings=void 0,t._protipClassInstance=void 0},namespaced:function(t){return this.settings.namespace+t.charAt(0).toUpperCase()+t.slice(1)},destroyItemInstance:function(t){this._itemInstances[t].destroy()},onItemDestoryed:function(t){delete this._itemInstances[t]},createItemInstance:function(t,s){var o=this._generateId()
...
else if(isNaN(this._input)){var t,e,i=[],s=!1,o=-1
this._finals=this._input.split(";").map(function(n){if(o++,n=n.trim(),"..."===n)s=!0
else if(n){var h=n.split(" ").map(function(t){return t.trim()})
return i.push(h[0]),e={lvl:1,key:h[0],left:parseInt(h[1],10)||0,top:parseInt(h[2],10)||0},0===o&&(t=e),e}}).filter(function(t){return!!t}),s&&this._positionsList.forEach(function(t){-1===i.indexOf(t.key)&&this._finals.push(t)}.bind(this))}else this._finals=this._positionsList.filter(function(t){return t.lvl<=this._input}.bind(this))}}),i})}).call(this,"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./Constants":3}],5:[function(t,e,i){(function(s){!function(o,n){"use strict"
...
var e
for(e=0;e<this._positionList.length&&!this._test(this._positionList[e]);e++);return this._result||new s(this._item)},_test:function(t){this._setProtipMinWidth()
...
var t=this._item.el.protip.width()+1
