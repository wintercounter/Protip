...
export const PROP_INTERACTIVE = 'interactive'
...
export const PROP_SKIN        = 'skin'
export const PROP_SIZE        = 'size'
export const PROP_SCHEME      = 'scheme'
export const PROP_MIXIN       = 'mixin'
export const PROP_OBSERVER    = 'observer'
export const PROP_PLACEMENT   = 'placement'
